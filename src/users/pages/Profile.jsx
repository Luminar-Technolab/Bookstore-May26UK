...
function Profile() {
  ...
  return (
    ...
    <div style={{width:'230px',height:'230px',borderRadius:'50%',marginTop:'-130px',marginLeft:'70px'}} className="bg-white p-3">
      <img width={'200px'} height={'200px'} style={{borderRadius:'50%'}} src={dp==""?"https://www.pngkey.com/png/full/349-3499617_person-placeholder-person-placeholder.png":dp.startsWith('https://lh3.googleusercontent.com/')?dp:`${axiosInstance.defaults.baseURL}/uploads/${dp}`} alt="profile" />
    </div>
